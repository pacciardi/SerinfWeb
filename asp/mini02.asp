<%
	...
	strOpcion=ucase(request.querystring("strOpcion"))
	...
	<div class="container">
		<nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item"><a href="../htm/mini.htm">Mini Web</a></li>
		    <li class="breadcrumb-item"><a href="../htm/mini02.htm">Adquirir</a></li>
		...
		<% if strOpcion<>"" then%>
			...
			<div class="row" id="formDatosPersonales">
				<div class="col-md-7">
					<div class="panel panel-default">
	  					<div class="panel-body">
							<form action="enviaDatosPersonales.asp?cual=mini" method="post" name="form1" onsubmit="return validar();">
				...
				<div class="col-md-5">
					<h3>Seleccionaste la opcion <strong><%=strOpcion%></strong> <img src="../img/ok_.png" alt=""></h3><br>
					<%
						if strOpcion="A" then
							response.write("<img src='../img/miniweb01.jpg' class='img-responsive imgProductos opciones'>")
						elseif strOpcion="B" then
							response.write("<img src='../img/miniweb02.jpg' class='img-responsive imgProductos opciones'>")
						else
							response.write("<img src='../img/miniweb03.jpg' class='img-responsive imgProductos opciones'>")
						end if
					%>
				</div>
			</div>
		...
		<% if enviado=1 then%>
			<div class="row" id="formPago">
				<div class="col-md-6">
					...
					<a mp-mode="dftl" href="https://www.mercadopago.com.ar/checkout/v1/redirect?preference-id=7178665-f00c51bc-ddf9-4694-8adb-2f3c274dec0e" name="MP-payButton" class='green-ar-l-sq-arall'>Pagar $3500</a>
