	...
	<div class="container">
		<nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item"><a href="../htm/full.htm">Full Web</a></li>
		    <li class="breadcrumb-item"><a href="../htm/full02.htm">Adquirir</a></li>
				...
				<div class="col-md-7">
					<div class="panel panel-default">
	  					<div class="panel-body">
							<form action="enviaDatosPersonales.asp?cual=full" method="post" name="form1" onsubmit="return validar();">
		...
		<% if enviado=1 then%>
			<div class="row" id="formPago">
				<div class="col-md-6">
					...
					<a mp-mode="dftl" href="https://www.mercadopago.com.ar/checkout/v1/redirect?preference-id=7178665-2a401502-e294-4142-b342-be0ace086f30" name="MP-payButton" class='green-ar-l-sq-arall'>Pagar $5500</a>
